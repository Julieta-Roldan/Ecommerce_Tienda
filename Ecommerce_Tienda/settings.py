"""
Django settings for Ecommerce_Tienda project.
...
SECRET_KEY = 'django-insecure-swf(qsx2&&#naar*(o#jz8q!jatw%1qrj)j3i8&v2i!qkcw%#4'
...
INSTALLED_APPS = [
    ...
    'core',             # configuraciones globales, utilidades
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'panel_admin.context_processors.panel_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'Ecommerce_Tienda.wsgi.application'
